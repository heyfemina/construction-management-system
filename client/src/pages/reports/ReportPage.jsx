...
const reportConfigs = {
  ...
  financial: {
    ...
    columns: [
      { key: "record_type", label: "Type", width: "110px" },
      { key: "name", label: "Name", width: "190px" },
      { key: "total_amount", label: "Total", width: "150px", className: "is-finance-total" },
      { key: "received_amount", label: "Received", width: "150px" },
      { key: "pending_amount", label: "Pending", width: "150px" },
      { key: "date", label: "Date", width: "120px" },
      { key: "notes", label: "Notes", width: "280px", className: "is-notes" },
    ],
  },
  sites: {
    title: "Site Reports",
